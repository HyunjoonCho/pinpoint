...
public class ContainerChart implements StatChart {
    ...
    public static class ContainerChartGroup implements StatChartGroup {
        ...
        private Map<ChartType, Chart<? extends Point>> newChart(List<SampledContainer> sampledContainers){
            Chart<AgentStatPoint<Long>> userCpuUsage = newChart(sampledContainers, SampledContainer::getUserCpuUsage);
            Chart<AgentStatPoint<Long>> systemCpuUsage = newChart(sampledContainers, SampledContainer::getSystemCpuUsage);
            Chart<AgentStatPoint<Long>> memoryUsage = newChart(sampledContainers, SampledContainer::getMemoryUsage);
        ...
        private Chart<AgentStatPoint<Long>> newChart(List<SampledContainer> sampledActiveTraces, Function<SampledContainer, AgentStatPoint<Long>> function) {
            TimeSeriesChartBuilder<AgentStatPoint<Long>> builder = new TimeSeriesChartBuilder<>(this.timeWindow, SampledContainer.UNCOLLECTED_POINT_CREATOR);
